...
test_basic_functionality() {
    ...
    docker run --rm \
        ...
        " || { log "Basic functionality test: FAILED"; ((FAILED_TESTS++)); }
}
...
test_privilege_dropping() {
    ...
    docker run --rm \
        ...
        " || { log "Privilege dropping test: FAILED"; ((FAILED_TESTS++)); }
}
...
test_data_ownership() {
    ...
    docker run --rm \
        ...
        " || { log "Data ownership test: FAILED"; ((FAILED_TESTS++)); }
}
...
test_upstream_config() {
    ...
    docker run --rm \
        ...
        " || { log "Upstream config test: FAILED"; ((FAILED_TESTS++)); }
}
